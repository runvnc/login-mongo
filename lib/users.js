...
(function() {
  var Mongolian, dash, db, fs, mustache, nodemailer, opts, passwordHash, popts, randpass, server, smtp, users,
    _this = this;
    ...
    function _$cb$_1(_$$_0) {
      if (_$$_0) {
        users.insert({
          email: email,
          name: name,
          passhash: passwordHash.generate(pass, popts)
        });
  ...
  function add(email, name, pass, cb) {
    var e, e1, existing, mailer, newuser, options, rendered;
